...
class testrail_tabs(connectDB):
    ...
    dim_tr_cases = Table(
        ...
        ForeignKeyConstraint(
            ["project_RC"],
            jira_tabs.dim_sq_config.primary_key,
            use_alter=True,
            name="fk_tr_cases_sq_config",
        ),
        ForeignKeyConstraint(
            ["typeID_RC"],
            dim_tr_case_types.primary_key,
            use_alter=True,
            name="fk_tr_case_type_sq_config",
        ),
        schema="SQ",
    )
    ...
    fact_tr_runs = Table(
        ...
        ForeignKeyConstraint(
            ...
            jira_tabs.dim_sq_config.primary_key,
            use_alter=True,
            name="fk_tr_run_sq_config",
        ),
        ForeignKeyConstraint(
            ["Refresh_Cycle"],
            jira_tabs.dim_refresh_history.primary_key,
            use_alter=True,
            name="fk_tr_run_index_refresh_hist",
        ),
        schema="SQ",
    )
    ...
    fact_tr_tests = Table(
        ...
        ForeignKeyConstraint(
            ["runID_RC"],
            fact_tr_runs.primary_key,
            use_alter=True,
            name="fk_tr_tests_runs",
        ),
        ForeignKeyConstraint(
            ["caseID_RC"],
            dim_tr_cases.primary_key,
            use_alter=True,
            name="fk_tr_tests_cases",
        ),
        ForeignKeyConstraint(
            ["Refresh_Cycle"],
            jira_tabs.dim_refresh_history.primary_key,
            use_alter=True,
            name="fk_tr_test_index_refresh_hist",
        ),
        schema="SQ",
    )
    ...
    fact_tr_refs = Table(
        ...
        ForeignKeyConstraint(
            ...
            dim_tr_cases.primary_key,
            use_alter=True,
            name="fk_tr_case_refs_cases",
        ),
        schema="SQ",
    )

    fact_tr_case_fields = Table(
        "fact_tr_case_fields",
        m,
        ...
        ForeignKeyConstraint(
            ...
            dim_tr_cases.primary_key,
            use_alter=True,
            name="fk_tr_case_fields_cases",
        ),
        schema="SQ",
    )

    fact_tr_groups = Table(
        "fact_tr_groups",
        m,
        Column("self", VARCHAR(255)),
        Column("id", BIGINT),
        ...
        ForeignKeyConstraint(
            ["projectID_RC"],
            dim_tr_projects.primary_key,
            use_alter=True,
            name="fk_tr_groups_projects",
        ),
        schema="SQ",
    )
    ...
    fact_tr_users = Table(
        ...
        ForeignKeyConstraint(
            ...
            dim_tr_projects.primary_key,
            use_alter=True,
            name="fk_tr_users_projects",
        ),
        schema="SQ",
    )

    fact_tr_suites = Table(
        "fact_tr_suites",
        m,
        Column("self", VARCHAR(255)),
        Column("id", BIGINT),
        ...
        ForeignKeyConstraint(
            ...
            dim_tr_projects.primary_key,
            use_alter=True,
            name="fk_tr_suites_projects",
        ),
        ForeignKeyConstraint(
            ["caseID_RC"],
            dim_tr_cases.primary_key,
            use_alter=True,
            name="fk_tr_suites_cases",
        ),
        schema="SQ",
    )

    fact_tr_section = Table(
        "fact_tr_section",
        m,
        Column("self", VARCHAR(255)),
        Column("id", BIGINT),
        ...
        ForeignKeyConstraint(
            ...
            dim_tr_projects.primary_key,
            use_alter=True,
            name="fk_tr_section_projects",
        ),
        ForeignKeyConstraint(
            ["caseID_RC"],
            dim_tr_cases.primary_key,
            use_alter=True,
            name="fk_tr_section_cases",
        ),
        schema="SQ",
    )
