...
#            print(mock_sys)
    ...
    def getData(self):
        data = {'caseID_RC': ['12334-4'],
                'id': [123], 
                'refs' : ['GCT-3424, GCT-3426, GCT-3485, GCT-3455, GCT-3603, GCT-3604, GCT-3629, GCT-3696, GCT-3697, GCT-3782, GCT-3816, GCT-3888, GCT-3889, GCT-3891, GCT-3938, GCT-4027, GCT-4028, GCT-4095, GCT-4107, GCT-4163, GCT-4233, GCT-4234, GCT-4236, GCT-4284, GCT-4285, GCT-4307, GCT-4286']}
