...
class columnHandling:
    ...
    def consolidateCutomFields(self, dfCore):
        ...
        if "severity" not in dfCore.columns:
            if "fields.customfield_19890.value" in dfCore.columns:
                dfCore.rename(
                    columns={"fields.customfield_19890.value": "severity"}, inplace=True
                )
            elif "fields.customfield_20083.value" in dfCore.columns:
                dfCore.rename(
                    columns={"fields.customfield_20083.value": "severity"}, inplace=True
                )
            elif "fields.customfield_20118.value" in dfCore.columns:
                dfCore.rename(
                    columns={"fields.customfield_20118.value": "severity"}, inplace=True
                )
            elif "fields.customfield_20005.value" in dfCore.columns:
                dfCore.rename(
                    columns={"fields.customfield_20005.value": "severity"}, inplace=True
                )
            elif "fields.customfield_11106.value" in dfCore.columns:
                dfCore.rename(
                    columns={"fields.customfield_11106.value": "severity"}, inplace=True
                )
        ...
        if "release phase" not in dfCore.columns:
            if "fields.customfield_19900.value" in dfCore.columns:
                dfCore.rename(
                    columns={"fields.customfield_19900.value": "release phase"},
                    inplace=True,
                )
            elif "fields.customfield_20081.value" in dfCore.columns:
                dfCore.rename(
                    columns={"fields.customfield_20081.value": "release phase"},
                    inplace=True,
                )
            elif "fields.customfield_20003.value" in dfCore.columns:
                dfCore.rename(
                    columns={"fields.customfield_20003.value": "release phase"},
                    inplace=True,
                )
            elif "fields.customfield_20128.value" in dfCore.columns:
                dfCore.rename(
                    columns={"fields.customfield_20128.value": "release phase"},
                    inplace=True,
                )
            elif "fields.customfield_11107.value" in dfCore.columns:
                dfCore.rename(
                    columns={"fields.customfield_11107.value": "release phase"},
                    inplace=True,
                )
        ...
        if "bug classification" not in dfCore.columns:
            if "fields.customfield_19901.value" in dfCore.columns:
                dfCore.rename(
                    columns={"fields.customfield_19901.value": "bug classification"},
                    inplace=True,
                )
            elif "fields.customfield_20080.value" in dfCore.columns:
                dfCore.rename(
                    columns={"fields.customfield_20080.value": "bug classification"},
                    inplace=True,
                )
            elif "fields.customfield_2004.value" in dfCore.columns:
                dfCore.rename(
                    columns={"fields.customfield_20004.value": "bug classification"},
                    inplace=True,
                )
            elif "fields.customfield_2129.value" in dfCore.columns:
                dfCore.rename(
                    columns={"fields.customfield_20129.value": "bug classification"},
                    inplace=True,
                )
            elif "fields.customfield_11487.value" in dfCore.columns:
                dfCore.rename(
                    columns={"fields.customfield_11487.value": "bug classification"},
                    inplace=True,
                )
        return dfCore
    ...
    def cleanColumnNames(self, project, dfCore, dfSatelite):
        ...
        for col in dfSatelite.filter(like="customfield").columns:
            try:
                dfSatelite.rename(
                    columns={col: str(col.lower().replace("fields.", ""))}, inplace=True
                )
            except:
